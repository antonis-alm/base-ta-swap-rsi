...
def _build_dashboard_config(strategy_config: dict[str, Any]):
    ...
    overbought = float(strategy_config.get("rsi_overbought", strategy_config.get("rsi_upper_band", 70)))
    oversold = float(strategy_config.get("rsi_oversold", strategy_config.get("rsi_lower_band", 30)))
